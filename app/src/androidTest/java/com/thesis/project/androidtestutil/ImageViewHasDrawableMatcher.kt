...
object ImageViewHasDrawableMatcher {
    ...
    fun hasDrawable(context: Context, @DrawableRes drawableResId: Int): BoundedMatcher<View, ImageView> {

        return object: BoundedMatcher<View, ImageView>(ImageView::class.java){

            override fun describeTo(description: Description?) { description?.appendText("matches with expected bitmap") }
